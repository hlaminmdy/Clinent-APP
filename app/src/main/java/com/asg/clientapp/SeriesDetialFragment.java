 ...
 */
public class SeriesDetialFragment extends Fragment {

    public SeriesDetialFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     myView = inflater.inflate(R.layout.fragment_series_detial, container, false);

        GoogleAds googleAds = new GoogleAds();
        googleAds.loadAdsVerticalAds(myView,getContext(),getActivity());
        googleAds.loadNataivetAds(myView,getContext());
    ...
    epCount=myView.findViewById(R.id.txtepcount);
       ...
       FirebaseConnect fconnet = new FirebaseConnect(getContext(),getFragmentManager());
       fconnet.getEpBySeriesName(model.seriesName);
