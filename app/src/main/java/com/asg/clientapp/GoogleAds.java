...
public class GoogleAds {
    ...
    public InterstitialAd loadInterstitialAds(Context context)
    {
        ...
        mInterstitialAd.setAdUnitId(context.getString(R.string.intersititial_unite_id));
    ...
    RewardedVideoAd loadRewaredVideoAds(final Context context) {
        MobileAds.initialize(context, context.getString(R.string.app_id));
    ...
    public void loadAdsVerticalAds(View myView, Context context,Activity activity)
    {
        MobileAds.initialize(context,context.getString(R.string.app_id));
    ...
    FrameLayout adContainer,adContaomer2,adContainer3;
    AdView adView3;
    ...
    public void loadThreeVerticalAds(View myView,Context context,Activity activity)
    {
        ...
        adContaomer2=myView.findViewById(R.id.adcontainer2);
    ...
    public void loadNataivetAds(final View myView, Context context) {
        MobileAds.initialize(context,context.getString(R.string.app_id));

        AdLoader adLoader = new AdLoader.Builder(context,context.getString(R.string.native_unite_ads))
        ...
        AdLoader adLoader2 = new AdLoader.Builder(context,context.getString(R.string.native_unite_ads))
                .forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
                    @Override
                    public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                        ColorDrawable background = new ColorDrawable(Color.GREEN);
