...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtallcategory=myView.findViewById(R.id.txtseries);
        allCategory=myView.findViewById(R.id.allcategory);

        SeriesFragment.activity = getActivity();
        MoviesFragment.activity = getActivity();
        ...
        FirebaseConnect fContent = new FirebaseConnect(getContext(),getFragmentManager());

        fContent.showSlide();
        fContent.getAllCategory();
