    ...
    public void onBindViewHolder(MyItems holder, final int position) {
        ...
        holder.mCircleTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FirebaseConnect fContent = new FirebaseConnect(context,fm);

                if (mArrayList.get(position).categoryName.equals(context.getString(R.string.all_str))) {
                    fContent.getAllMovies();
                    fContent.getAllSeries();
                } else {
                    fContent.getAllMoviesByCategory(mArrayList.get(position).categoryName);
                    ;
                    fContent.getAllSeriesByCategory(mArrayList.get(position).categoryName);
                }
        ...
        holder.categoryitem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FirebaseConnect fContent = new FirebaseConnect(context);
                if (mArrayList.get(position).categoryName.equals(context.getString(R.string.all_str)))
