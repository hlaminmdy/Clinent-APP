 ...
 */
public class VideoDetialFragment extends Fragment {

     public VideoDetialFragment() {
    ...
    ImageView fullscreenButton;
     ...
     public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         myView = inflater.inflate(R.layout.fragment_video_detial, container, false);


         playerConent = myView.findViewById(R.id.play_connet);
         ...
         fullscreenButton.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 if (isfullscreen)
                 {
                     ...
                     playerConent.setLayoutParams(params);
                     isfullscreen=false;
